function site1(checkbox){
    if (checkbox.checked){
        document.getElementById('monitor').style.background = 'url(../ASSETS/projetos/site1.png) center/cover no-repeat';
...
function site2(checkbox){
    if (checkbox.checked){
        document.getElementById('monitor').style.background = 'url(../ASSETS/projetos/site2.png) center/cover no-repeat';
...
function site3(checkbox){
    if (checkbox.checked){
        document.getElementById('monitor').style.background = 'url(../ASSETS/projetos/site3.png) center/cover no-repeat';
...
function site4(checkbox){
    if (checkbox.checked){
        document.getElementById('monitor').style.background = 'url(../ASSETS/projetos/site4.png) center/cover no-repeat';
